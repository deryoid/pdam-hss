...
$id   = $_GET['id'];
$data = $koneksi->query("SELECT * FROM kebocoran WHERE id_kebocoran = '$id'");
...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Ubah Kebocoran</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card card-primary">
                                    <div class="card-header">
                                        <h3 class="card-title">Kebocoran</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <!-- form start -->
                                    <div class="card-body" style="background-color: white;">
                                        ...
                                        <div class="form-group row">
                                            <label for="" class="col-sm-2 col-form-label">Letak Kebocoran</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="letak_kebocoran" value="<?= $row['letak_kebocoran']; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
    ...
    if (isset($_POST['submit'])) {
        ...
        $letak_kebocoran     = $_POST['letak_kebocoran'];
        $tgl_perbaikan     = $_POST['tgl_perbaikan'];
        $biaya     = $_POST['biaya'];

        $submit = $koneksi->query("UPDATE kebocoran SET  
                            nama = '$nama',
                            tgl_permintaan = '$tgl_permintaan',
                            link_gmap = '$link_gmap',
                            nama_teknisi = '$nama_teknisi',
                            letak_kebocoran = '$letak_kebocoran',
