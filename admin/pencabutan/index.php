        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Data Pencabutan Meter</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <!-- <li class="breadcrumb-item"><a href="#">Data Master</a></li> -->
                                <li class="breadcrumb-item active">Data Pencabutan Meter</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                                            ...
                                            ORDER BY sa.id_pelanggan DESC");
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?= $row['status_cabut'] ?> |
                                                            <a href="pencabutan?id=<?= $row['id_pelanggan'] ?>" class="btn btn-danger btn-sm" title="Pencabutan"><i class="fa fa-reply-all"></i></a> | <a href="<?= base_url() ?>/filependukung/<?= $row['bukti_cabut'] ?>" data-toggle="lightbox" data-title="Foto Bukti"><i class="fa fa-images"></i></a>
                                                        </td>
                                                    </tr>
                                                <?php } ?>
                                            </tbody>
